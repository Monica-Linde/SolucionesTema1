...
#es acampanada, simétrica, unimodal, con media y mediana similares y las colas 
#cercanas a 0
#Por lo tanto como vemos en la representación gráfica no es una campana.
#Por lo tanto no es una distribución gaussiana
```
